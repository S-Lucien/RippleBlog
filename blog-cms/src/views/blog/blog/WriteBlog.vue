	...
	<div>
		<el-form :model="form" :rules="formRules" ref="formRef" label-position="top">
			...
			<el-form-item label="文章正文" prop="content">
				<mavon-editor ref="mdEditor" v-model="form.content" @imgAdd="$imgAdd"/>
			</el-form-item>
...
<script>
	...
	import {getCategoryAndTag, saveBlog, getBlogById, updateBlog, uploadImg} from '@/api/blog'
	...
	export default {
		...
		watch: {
			...
			'form.content'(newValue) {
				this.form.words = newValue ? this.form.content.length : null
			}
		},
		created() {
			this.getData()
		...
		methods: {
			...
			$imgAdd(pos, $file){
				...
				uploadImg(formdata).then((res) => {
					this.$refs.mdEditor.$img2Url(pos, res.msg);
				})
			}
		}
	}
